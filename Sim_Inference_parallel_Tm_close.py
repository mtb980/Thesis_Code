...
def f(j):
    ...
    for i in range(sample_size-1):
        if i>10000:
            ...
            pf=20
        Tm1t=scist.norm.rvs(loc=Tm1[-1],scale=10/pf,size=1)[0] #log normal variation 
        ...
        Tm2t=scist.norm.rvs(loc=Tm2[-1],scale=20/pf,size=1)[0] #log normal variation 
...
Chain1.to_csv('SIM_close_output/Chain1.csv',index=False)
Chain2.to_csv('SIM_close_output/Chain2.csv',index=False)
Chain3.to_csv('SIM_close_output/Chain3.csv',index=False)
Chain4.to_csv('SIM_close_output/Chain4.csv',index=False)
